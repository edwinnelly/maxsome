...
//fetch the category
$query = "SELECT * FROM hmo WHERE id='$cat_fid' LIMIT 1";
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1"><?php echo ($data['hmo_name']); ?></h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="hmo.php"><button class="btn btn-default hidden-xs ml-2">Manage HMOs</button></a>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="dpt" class="form-control" name="dpt"
                                                        placeholder="Name Of hmo" required value="<?php echo ($data['hmo_name']); ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="abbr" name="abbr"
                                                        placeholder="Abbr" value="<?php echo ($data['abbr']); ?>" required>
                                                </div>
                                            </div>
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "HMO Updating, Please wait redirecting...!",
                                icon: "success",
                            });
                                setTimeout(function () {
                                var btn = $("#reset-btn");
