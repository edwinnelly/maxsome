                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Lab Result Template </h1>
                        </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <form name="myForm" id="myForm" action="lab_result_setup_generate.php" method="get" class="form mt-5">
                                <div class="body">
                                    <div class="row clearfix">

                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <select class="form-control show-tick" name="test_type" id="test_type" required>
                                                    <option value="0">Choose Lab Test</option>
                                                    <?php
                                                    $data = $app->fetch_query($lab_test_list_sql);

                                                    foreach ($data as $datas) {
                                                        ?>
                                                        <option value="<?php echo base64_encode($datas['id']); ?>">
                                                            <?php echo $datas['test_name']; ?>
                                                        </option>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <input type="number" class="form-control" id="fd" name="fd"
                                                    placeholder="Choose numbers of entries" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-12">
                                            <div class="mt-4">
                                                <button type="submit" id="reset-btn" class="btn btn-primary">Next
                                                </button>
                                            </div>
                                        </div>
                                    </div>
