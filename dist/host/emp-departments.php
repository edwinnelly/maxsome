...
$fetch_dpt = $app->fetch_query(query: $department_leaders_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Departments</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="department_add.php"><button class="btn btn-secondary hidden-xs">Add New
                                    Department</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Total Employee</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo ($fetch_dpt['staffs_in_department']); ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="department_edit?fid=<?php echo base64_encode($fetch_dpt['id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['department_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($fetch_dpt['department_name']); ?>"></i></button>
