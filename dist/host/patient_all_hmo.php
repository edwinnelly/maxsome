                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Patients List / Hmo</h1>
                        </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="patient_edit_hmo.php?fid=<?php echo $value['pid']; ?>&&st=<?php echo base64_encode($app->stringFormat($value['patient_name'], 20)); ?>
                                                                ">Edit Profile</a>

                                                                <a class="dropdown-item delete_emp" style="cursor: pointer;"
                                                                    data-id="<?= $value['pid']; ?>"
                                                                    data-emp_name="<?php echo ($value['patient_name']); ?>">disable
                                                                    Account</a>
                                                            </div>
                                                        </div>
