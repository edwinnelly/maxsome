...
include "config/checkers.php";
 ...
 //sql command
 $query = "SELECT * FROM drug_supplier WHERE id=$get_staff_id";
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Edit Supplier</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="drug_suppliers"><button class="btn btn-default hidden-xs ml-2">Manage
                                    Suppliers</button></a>
                                    ...
                                    <div class="body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="fn" class="form-control" name="fn"
                                                        placeholder="Supplier Name" value="<?php echo $data['supplier'];  ?>" required>
                                                        
                                                </div>
                                            </div>
                                            <input type="hidden" value="<?php echo $data['id'];  ?>" name="dle">

                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?php echo $data['addr'];  ?>" id="address" name="address"
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-md-3 col-sm-12">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" value="<?php echo $data['phone'];  ?>" id="phone" name="phone"
