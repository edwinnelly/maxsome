...
//sql command
$fetch_emp = $app->fetch_query($employee_data_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Employee List</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="employee_add.php"><button class="btn btn-secondary hidden-xs">Add
                                    Employee</button></a>
                        </div>
                    </div>
                </div>
                                            ...
                                            foreach($fetch_emp as $key => $value) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="d-flex">
                                                        ...
                                                        <div class="ml-2">
                                                            <h6 class="mb-0" style="text-transform: capitalize;">
                                                                ...
                                                                <?php echo $app->stringFormat($value['firstname']. ' ' . $value['lastname'],19); ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php echo $app->stringFormat($value['department_name'],30); ?>
                                                    </td>
                                                    <td>
                                                    <?php echo $app->stringFormat($value['specializations_name'],20); ?>
                                                       
                                                    </td>
                                                    <td>
                                                        <?php if ($value['access_level_id'] == 1) {
                                                            echo "Admin";
                                                        } elseif ($value['access_level_id'] == 2) {
                                                            echo "Lab";
                                                        } elseif ($value['access_level_id'] == 3) {
                                                            echo "Nurse";
                                                        } elseif ($value['access_level_id'] == 4) {
                                                            echo "Radiology";
                                                        } elseif ($value['access_level_id'] == 5) {
                                                            echo "Doctor";
                                                        } elseif ($value['access_level_id'] == 6) {
                                                            echo "Front Desk";
                                                        } elseif ($value['access_level_id'] == 7) {
                                                            echo "Pharmacy";
                                                        }
                                                        ; ?>
                                                    </td>
                                                    <td>
                                                        <a href="employee_edit.php?fid=<?php echo $value['staff_id']; ?>&&st=<?php echo base64_encode($value['firstname'] . ' ' . $value['lastname']); ?>
                                                                "><button type="button"
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-emp_name="<?php echo htmlentities($value['firstname'] . ' ' . $value['lastname']); ?>"></i></button>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
