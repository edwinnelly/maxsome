...
<head>
    ...
    <title>EMR :: Patient lab test</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1"> Patients Test List </h1>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_query = $app->fetch_query($patient_lab_quuee_sql);
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a class="dropdown-item" href="lab_test_processing?fid=<?php echo base64_encode($value['pid']); ?>">Take Sample</a> 
                                                            </div>
                                                        </div>
