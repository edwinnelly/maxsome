                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT patient_test.*,lab_test_case.test_name,staffs_accounts.firstname,staffs_accounts.lastname from patient_test,lab_test_case,staffs_accounts WHERE patient_test.test_id=lab_test_case.id and patient_test.taken_by=staffs_accounts.id and patient_test.patient_id=$get_staff_id and patient_test.status=0 and patient_test.payment_status='account'";
...
$sum_test_result = "SELECT SUM(amount) as amount from patient_test where patient_id=$get_staff_id and payment_status='account'";
    ...
    <script>
        ...
        $(document).on('click', '.account', function () {
            ...
            if (pid_account === '' || pid_account === 0) {
                ...
                $.ajax({
                    url: "ajax/account_approve_lab_payment",
                    method: "POST",
                    data: {
