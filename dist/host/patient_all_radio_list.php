                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Patients List / Radiography</h1>
                        </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_query = $app->fetch_query($patient_radio_quuee_sql);
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="radios_departments.php?fid=<?php echo $value['pid']; ?>&&st=<?php echo base64_encode($app->stringFormat($value['patient_name'], 20)); ?>
                                                                ">RAD Profile</a>
