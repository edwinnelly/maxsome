                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"> Radiography Profile</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                           
                            <a href="add_patient_radio.php?fid=<?php echo (int) $get_staff_id;  ?>&&cod=<?php echo rand(12345,123456); ?>"> <button class="btn btn-secondary hidden-xs ml-2">Add Test</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="table-responsive">
                                                ...
                                                <table class="table table-bordered table-hover js-basic-example dataTable">
                                                    ...
                                                    LEFT JOIN 
                                                        staffs_accounts 
                                                    ON 
                                                        patient_test_radio.taken_by = staffs_accounts.id 
                                                    LEFT JOIN 
                                                        radio_departments 
                                                    ON 
                                                        patient_test_radio.dpt = radio_departments.DepartmentID
                                                    LEFT JOIN 
                                                        radio_graphy_test 
                                                    ON 
                                                        patient_test_radio.test_id = radio_graphy_test.id 
                                                    WHERE 
                                                        patient_test_radio.patient_id =$get_staff_id";
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <p class="mb-0">
                                                                       ST-<?php  echo $fetch_dpt['approved_by']; ?> 
                                                        </p>
                                                                </td>
                                                                <td>
                                                                    <p class="mb-0">
                                                                ...
                                                                <td>
                                                                    <?php  $payment_status = $fetch_dpt['status']; 
                                                                    if($payment_status==1){
                                                                ...
                                                                <td>
                                                                <?php  $status_rs = $fetch_dpt['status']; 
                                                                    if($status_rs==4){
                                                                        echo'<a href="radio_view_result.php?fid='.$fetch_dpt['passkey'].'"><span class="badge badge-success">View Result</span></a>';
                                                                    }else{
