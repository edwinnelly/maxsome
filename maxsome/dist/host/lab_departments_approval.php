...
$fetch_dpt = $app->fetch_query($department_lab_approval_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Lab Departments / Result Approval</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="patient_all_lab.php"><button class="btn btn-secondary hidden-xs">Patients Profile</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Department Head</th>
                                                <th class="border-top-0">Awaiting Approval</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['department_name']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <img src="../user.avif" class="rounded-circle avatar sm mr-1"
                                                            alt="">
                                                        <span>
                                                            <?php if ($fetch_dpt['leader'] == 0) {
                                                                echo "Empty";
                                                            } else {
                                                                echo ($fetch_dpt['firstname'] . ' ' . $fetch_dpt['lastname']);
                                                            } ?>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <span class="badge badge-danger" style="font-size: 13px;border-radius: 50px;"><?php echo ($fetch_dpt['staffs_in_department']); ?></span>
                                                    </td>
                                                    <td>
                                                        
                                                    <a href="lab_department_test_approval.php?fid=<?php echo base64_encode($fetch_dpt['id']);  ?>"><button class="btn btn-primary btn-sm">Check Result</button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Department Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do You Want To Delete The Department</h5>
            </div>
