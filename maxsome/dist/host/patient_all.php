                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Patients List</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="patient-add.php"><button class="btn btn-secondary hidden-xs">Add
                                    Patients</button></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_query = $app->fetch_query($patient_records_sql);
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="patient_radiography_profile.php?fid=<?php echo $value['pid']; ?>&&st=<?php echo base64_encode($app->stringFormat($value['patient_name'], 20)); ?>
                                                                ">Radiography</a>

                                                                <a class="dropdown-item delete_emp" style="cursor: pointer;" data-id="<?= $value['pid']; ?>"
                                                                data-emp_name="<?php echo ($value['patient_name']); ?>">Delete Patient</a>
                                                            </div>
                                                        </div>
