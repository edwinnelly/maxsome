...
<head>
    ...
    <title>EMR :: Patient list transactions</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1"> Transactions Window</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <!-- <a href="#"><button class="btn btn-secondary hidden-xs">Refresh</button></a> -->
                        </div>
                    </div>
                </div>
            </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a class="dropdown-item" href="finance_lab_patientss?fid=<?php echo base64_encode($value['pid']); ?>">Lab Bills</a>
                                                                <a class="dropdown-item" href="finance_radio_patients?fid=<?php echo base64_encode($value['pid']); ?>">Radiography Bills</a>
