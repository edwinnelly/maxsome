                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Specialization</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="add_specialization.php"><button class="btn btn-secondary hidden-xs">Add New
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Specialization Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo htmlspecialchars($fetch_dpt['specializations_name']); ?>
                                                        </h6>
                                                    </td>
                                                    
                                                    <td>
                                                        <a
                                                            href="specialzation_edit?fid=<?php echo base64_encode($fetch_dpt['id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['specializations_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($fetch_dpt['specializations_name']); ?>"></i></button>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Specialization Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do You Want To Delete This Specialization</h5>
            </div>
