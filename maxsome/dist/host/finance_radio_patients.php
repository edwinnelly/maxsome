...
<head>
    ...
    <title>:: Emr :: Radiography payment </title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"> Radiography Profile Bill</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="patient_all_finance.php"><button class="btn btn-default hidden-xs ml-2">Manage Patient</button></a>
                            <a href="unpaid_radio_bill.php?fid=<?php echo base64_encode($get_staff_id);  ?>"> <button class="btn btn-secondary hidden-xs ml-2">Unpaid Transaction</button></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="body">
                                ...
                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT patient_test_radio.*,radio_graphy_test.sample from patient_test_radio,radio_graphy_test WHERE patient_test_radio.test_id=radio_graphy_test.id and  patient_test_radio.status=1 and patient_test_radio.patient_id=$get_staff_id and patient_test_radio.payment_status='paid'";
