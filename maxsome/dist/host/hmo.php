...
<head>
    ...
    <title>:: Emr :: Health Maintenance Organizations (HMOs)</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item active">HMOs</li>
                            </ul>
                            <h1 class="mb-1 mt-1">HMOs</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="hmo_add.php"><button class="btn btn-secondary hidden-xs">Add New
                                    HMOs</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">HOMS LIST</th>
                                                <th class="border-top-0">ABBR </th>
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_hmo = $app->fetch_query($hmo_sql);
                                            $sn = 1;
                                            foreach ($fetch_hmo as $data) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="hmo_edit?fid=<?php echo base64_encode($data['id']); ?>&&cat_name=<?php echo base64_encode($data['hmo_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($data['hmo_name']); ?>"></i></button>

                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                class="zmdi zmdi-eye delete_emp"
                                                                data-id="<?php echo ($data['id']); ?>"
                                                                data-dpt="<?php echo ($data['hmo_name']); ?>"></i></button>
                                                    </td>
                                                </tr>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "HMO Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do You Want To Delete The HMO</h5>
            </div>
