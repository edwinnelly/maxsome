...
$fetch_dpt = $app->fetch_query($drugs_category_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Drug category</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="add_drug_category.php"><button class="btn btn-secondary hidden-xs">Add New
                            Drug category</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a
                                                            href="drug_category_edit?fid=<?php echo base64_encode($fetch_dpt['id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['category_name']); ?>"><button
