...
if (isset($hmopass)) {
    ...
    $check_query = "SELECT * FROM hmo_radio_group WHERE case_id = '$test_id_n' and profile_id='$plan_id' and hmo_id='$hmopass'";
    ...
    if ($count > 0) {
        ...
        $query = "INSERT INTO `hmo_radio_group` (`id`, `hmo_id`, `profile_id`, `allowance`, `status`, `case_id`, `date_created`) VALUES (NULL, '$hmopass', '$plan_id', NULL, NULL, '$test_id_n', NULL)";
