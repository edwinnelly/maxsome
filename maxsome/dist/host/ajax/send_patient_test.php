...
if (isset ($test_id)) {
    $query = "INSERT INTO `patient_test` (`id`, `test_id`, `result`, `approved_by`, `passkey`, `dated_created`, `status`, `patient_id`, `taken_by`, `payment_status`, `hmo`,`amount`,`dpt`) VALUES (NULL, '$test_id', NULL, NULL, '$test_key', '$formattedDate', '0', '$pid', '$spid', 'notpaid', 0,'$amount','$dpt')";
