...
<head>
    ...
    <title>:Add New Radiography Profile</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add Radiography Case</h1>
                        </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" id="sample" class="form-control" name="sample"
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            if (data.trim() == "success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "New Radiography Test Created, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    location.reload();
