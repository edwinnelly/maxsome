...
//fetch the category
$sqls = "SELECT department.*,staffs_accounts.firstname,staffs_accounts.lastname FROM department LEFT JOIN staffs_accounts ON department.leader = staffs_accounts.id where department.id = $cat_fid";
$fetch_department1=$app->fetch_query($sqls);
foreach ($fetch_department1 as $fetch_department);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1"><?php echo htmlspecialchars($fetch_department->department_name);   ?></h1>
                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="dpt" class="form-control" name="dpt"
                                                        placeholder="Name Of Department" required value="<?php echo ($fetch_department['department_name']);   ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="abbr" name="abbr"
                                                        placeholder="Abbr" value="<?php echo ($fetch_department['abbr']);   ?>" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    <select class="form-control show-tick" id="dpt_head" name="dpt_head">
                                                        <option value="<?php echo ($fetch_department['leader']);   ?>"><?=  $fetch_department['firstname']. " " .$fetch_department['lastname']; ?></option>
                                                        <?php
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "Department Created, Please wait redirecting...!",
                                icon: "success",
                            });
                                setTimeout(function () {
                                var btn = $("#reset-btn");
