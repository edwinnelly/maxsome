                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            hpr.request_date FROM hmo_payment_requests hpr JOIN patient_data pd ON hpr.patient_id = pd.pid WHERE hpr.status = 'pending' and hpr.hmo_id='$hmo_key' GROUP BY hpr.patient_id";
