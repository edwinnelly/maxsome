...
<head>
    ...
    <title>:Add New drug brand category</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add Drug Brand Category</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="drug_brand_list.php"><button class="btn btn-default hidden-xs ml-2">Manage Drug
                                    Brand Category</button></a>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" id="dpt" class="form-control" name="dpt"
                                                    placeholder=" Drug Brand Category" required>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            function validateForm() {
                ...
                if (dpt === "") {
                    Swal.fire({
                        title: "The Brand Name Can Not Be Empty",
                        text: "Try Again!",
                        icon: "error"
                    });
                    return false;
                ...
                if (dpt.length < 5) {
                    Swal.fire({
                        title: "Error!",
                        text: "Brand must be at least 8 characters long.",
                        icon: "error",
                    });
                    return false;
                }
            ...
            $("#myForm").on('submit', (function (e) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "ajax/add_drug_category_brand",
                        type: "post",
                        data: datas,
                        contentType: false,
                        cache: false,
                        ...
                        success: (data) => {
                            ...
                            if (data.trim() == "success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "Drug Brand Created, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    var btn = $("#reset-btn");
                                    btn
                                        .attr("disabled", false)
                                        .html("Drug Brand Created!");
                                    location.href = "drug_brand_list";
                                }, 3000);
                            } else {
                                Swal.fire({
                                    title: "Error!",
