...
$fetch_dpt = $app->fetch_query($active_ptr_test_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Radio Departments / New Test</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="patient_all_radio.php"><button class="btn btn-secondary hidden-xs">Patients Profile</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['DepartmentName']; ?>
                                                        </h6>
                                                    </td>
                                               
                                                    <td>
                                                        <span class="badge badge-danger" style="font-size: 13px;border-radius: 50px;"><?php echo ($fetch_dpt['live_tst']); ?></span>
                                                    </td>
                                                    <td>
                                                        
                                                    <a href="radio_department_test.php?fid=<?php echo $fetch_dpt['DepartmentID']+90909012;  ?>"><button class="btn btn-primary btn-sm">Open cases</button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
