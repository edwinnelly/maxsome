                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add Asset</h1>
                        </div>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="asset_name" class="form-control" name="asset_name"
                                                        placeholder="Name Of Asset" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="asset_price" class="form-control" name="asset_price"
                                                        placeholder="Asset Price" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="asset_location" class="form-control" name="asset_location"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="owner" class="form-control" name="owner"
                                                        placeholder="Asset owner" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="asset_date" name="asset_date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control show-tick" id="condition" name="condition">
