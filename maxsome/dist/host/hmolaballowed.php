                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"><?=  $get_plan_name; ?> / Lab</h1>
                        </div>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $sql = "SELECT hmo_lab_group.*,lab_test_case.test_name,lab_test_case.test_price from hmo_lab_group,lab_test_case WHERE hmo_lab_group.case_id=lab_test_case.id and hmo_lab_group.profile_id=$get_plan_id and hmo_lab_group.hmo_id=$get_hmo_id";
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0">₦<?= number_format($fetch_dpt['test_price'],2); ?>
                                                                    </h6>
                                                                </td>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.trim() == 'success') {
                            ...
                            Swal.fire({
                                title: "Failed!",
                                text: "Test Case Already Exist, Please try again later...!",
                                icon: "error",
                            });
                            const btn = $("#addtest");
                            btn.attr('disabled', false).html('<i class="fa fa-spin fa-spinner"></i> Try Again...');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.trim() == 'success') {
                            Swal.fire({
                                title: "success!",
                                text: "Test Removed!!, Please wait redirecting...!",
                                icon: "success",
                            });
                            setTimeout(function () {
                                location.reload();
