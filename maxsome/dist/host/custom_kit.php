...
$fetch_dpt = $app->fetch_query($kit_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Custom Kit Mgt</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="custom_kit_add.php"><button class="btn btn-secondary hidden-xs">Add Custom
                                    Kit</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Kit Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['kit_name']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['kit_type']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($fetch_dpt['kit_name']); ?>"></i></button>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Custom Kit Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
