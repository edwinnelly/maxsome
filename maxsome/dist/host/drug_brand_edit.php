...
$query = "select * from drug_brand_category where id='$cat_fid'";
                ...
                <div class="container">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="drug_category.php"><button class="btn btn-default hidden-xs ml-2">Manage
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" id="dpt" class="form-control" name="dpt"
                                                    placeholder="Name Of Brand Category" required
                                                    value="<?php echo ($fetch_department['category_name']); ?>"
                                                    required>
                                            </div>
                                        </div>
        ...
        $(document).ready(function () {
            function validateForm() {
                ...
                if (dpt.length < 5) {
                    Swal.fire({
                        title: "Error!",
                        text: "Brand must be at least 5 characters long.",
                        icon: "error",
                    });
                    return false;
                }
            ...
            $("#myForm").on('submit', (function (e) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "ajax/update_drug_category_brand",
                        type: "post",
                        data: datas,
                        contentType: false,
                        cache: false,
                        ...
                        success: (data) => {
                            ...
                            if (data.trim() == "success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "Category Updated, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    var btn = $("#reset-btn");
                                    ...
                                    location.href = "drug_brand_list.php";
                                }, 3000);
                            } else {
                                Swal.fire({
                                    title: "Error!",
