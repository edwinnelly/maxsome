                ...
                <div class="container">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href=""><button class="btn btn-default hidden-xs ml-2">Use HMO Profile
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                        <?= $app->stringFormat($fetch_dpt['test_name'],25); ?>
                                                                    </h6>
                                                                </td>
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-sm btn-default"><i
                                                                            ...
                                                                            data-dpt="<?php echo $fetch_dpt['dpt']; ?>"
                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT patient_test.*,lab_test_case.test_name,staffs_accounts.firstname,staffs_accounts.lastname from patient_test,lab_test_case,staffs_accounts WHERE patient_test.test_id=lab_test_case.id and patient_test.taken_by=staffs_accounts.id and patient_test.patient_id=$get_staff_id and patient_test.status=0";
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                        <?= $app->stringFormat($fetch_dpt['test_name'],20); ?>
                                                                    </h6>
                                                                </td>
...
$sum_test_result = "SELECT SUM(amount) as amount from patient_test where patient_id=$get_staff_id and status=0";
