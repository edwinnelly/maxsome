                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"><?=  $get_plan_name; ?> / Pharmacy</h1>
                        </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                        <?= $app->stringFormat($fetch_dpt['drugs_name'],25); ?>
                                                                    </h6>
                                                                </td>
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                        <?= $app->stringFormat($fetch_dpt['category_name'], 20); ?>
                                                                    </h6>
                                                                </td>
                                                                <td>
                                                                    <h6 class="mb-0">
                                        ...
                                        <div class="body">
                                            <div class="table-responsive">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT hmo_pharmacy_group.*,drugs_list.drugs_name,drugs_list.selling_price from hmo_pharmacy_group,drugs_list WHERE hmo_pharmacy_group.case_id=drugs_list.id and hmo_pharmacy_group.profile_id=$get_plan_id and hmo_pharmacy_group.hmo_id=$get_hmo_id";
                                                        ...
                                                        foreach ($fetch_dpt as $fetch_dpt) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h6 class="mb-0">
                                                                        <?= $app->stringFormat($fetch_dpt['drugs_name'],20); ?>
                                                                    </h6>
                                                                </td>
    ...
    <script>
        $(document).on('click', '.addtest', function () {
            ...
            if (plan_id === '' || plan_id === 0) {
                ...
                $.ajax({
                    url: "ajax/add_hmo_plan_pharmacy",
                    method: "POST",
                    data: {
        ...
        $(document).on('click', '.removetest', function () {
            ...
            if (test_id === '' || test_id === 0) {
                ...
                $.ajax({
                    url: "ajax/delete_hmo_plan_pharmacy",
                    method: "POST",
                    data: {
                        test_id: test_id
                    },
                    success: function (data) {
                        if (data.trim() == 'success') {
                            Swal.fire({
                                title: "success!",
                                text: "Drug Removed!!, Please wait redirecting...!",
                                icon: "success",
                            });
                            setTimeout(function () {
                                location.reload();
