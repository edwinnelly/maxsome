...
<head>
    ...
    <title>:: Emr :: Radiography departments</title>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item active">Radiography departments</li>
                            </ul>
                            <h1 class="mb-1 mt-1">Radiography departments</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="add_radio_department.php"><button class="btn btn-secondary hidden-xs">Add New
                            Radiography Department</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Department List</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-id="<?php echo ($data['DepartmentID']); ?>"
                                                                data-dpt="<?php echo ($data['DepartmentName']); ?>"></i></button>
        ...
        $(document).on('click', '.delete_emp', function () {
            ...
            $("#delete_emp").click(function () {
                ...
                if (id_del === '' || id_del === 0) {
                    ...
                    $.ajax({
                        url: "ajax/delete_radio_department",
                        method: "POST",
                        data: {
                            id_del: id_del
                        },
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Delete The Radiography Departments</h5>
            </div>
