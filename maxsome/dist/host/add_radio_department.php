                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item">Radiography</li>
                                <li class="breadcrumb-item active">Add</li>
                            </ul>
                            <h1 class="mb-1 mt-1">New Radiography Department</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="radio_departments.php"><button class="btn btn-default hidden-xs ml-2">Manage Radiography</button></a>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="dpt" class="form-control" name="dpt"
                                                        placeholder="Name Of Radiography Department" required  required>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            function validateForm() {
                ...
                if (dpt === "") {
                    Swal.fire({
                        title: "The Radiograhy Name Can Not Be Empty",
                        text: "Try Again!",
                        icon: "error"
                    });
                    return false;
                ...
                if (dpt.length < 4) {
                    Swal.fire({
                        title: "Error!",
                        text: "Radiograhy must be at least 5 characters long.",
                        icon: "error",
                    });
                    return false;
                }
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "Radiograhy Department Added, Please wait redirecting...!",
                                icon: "success",
                            });
                                setTimeout(function () {
                                var btn = $("#reset-btn");
                                btn
                                .attr("disabled", false)
                                .html("Radiograhy Department Added!");
                                location.href="radio_departments";
                            }, 3000);     
                            } else {
                            Swal.fire({
                                title: "Error!",
