...
$fetch_dpt = $app->fetch_query($account_list_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Account List</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="account"><button class="btn btn-secondary hidden-xs">Add New
                                    Account</button></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['account_name']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <span>
                                                            <?php
                                                            echo $fetch_dpt['account_no'];
                                                            ?>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <?php $bal = ($fetch_dpt['balance']);
                                                        echo ($bal); ?>
                                                    </td>
                                                    <td>
                                                        <a
                                                            href="account_edit?fid=<?php echo base64_encode($fetch_dpt['id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['account_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($fetch_dpt['account_name']); ?>"></i></button>
