...
<head>
    ...
    <title>:Add New drug category</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add Drug Category</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="drug_category.php"><button class="btn btn-default hidden-xs ml-2">Manage Drug Category</button></a>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="dpt" class="form-control" name="dpt"
                                                        placeholder="Name Of Drug category" required>
                                                </div>
                                            </div>
                                        </div>
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "Drug Category Created, Please wait redirecting...!",
                                icon: "success",
                            });
                                setTimeout(function () {
                                var btn = $("#reset-btn");
                                btn
                                .attr("disabled", false)
                                .html("Drug Category Created!");
                                location.href="drug_category";
                            }, 3000);     
                            } else {
                            Swal.fire({
                                title: "Error!",
