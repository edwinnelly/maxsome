...
//sum the order
$sum_order = $app->fetch_query($sum_purchase_account_sql);
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Purchase Order / Unpaid /  ₦<?php echo number_format($total_sum['total_pending']); ?></h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="purchase_order_paid_account.php"><button class="btn btn-secondary hidden-xs">Purchase
                                    Order</button></a>
                            <a><button class="btn btn-secondary hidden-xs bill_account">Make Payment
                                </button></a>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover js-basic-example dataTable mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $fetch_query = $app->fetch_query($unpaid_purchase_order_account_sql);
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item delete_order_btn" id="" data-id="<?php if ($value['send_to_account'] == 'paid') {
                                                                } else {
                                                                    echo $value['id'];
                                                                } ?>"
                                                                    data-drug_name="<?php echo ($app->stringFormat($value['drugs_name'], 20)); ?>">Delete
                                                                    Order</a>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.trim() == 'success') {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "Purchase Order paid!, Please wait redirecting...!",
                                icon: "success",
                            });
