...
$fetch_dpt = $app->fetch_query($department_lab_sql);
?>
<!doctype html>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Lab Departments / Lab Test</h1>
                        </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Total Pending Test</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="lab_department_test.php?fid=<?php echo base64_encode($fetch_dpt['id']);  ?>"><button class="btn btn-primary btn-sm">Open cases</button></a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
