...
//fetch the category
$sqls = "select * from expense_category where id = $cat_fid";
...
<head>
    ...
    <title>Edit Expense Account</title>
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Edit Expense Account</h1>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <form name="myForm" id="myForm" method="post">
                                <form name="myForm" id="myForm" method="post" class="form mt-5">
                                    <div class="body">
                                        <div class="row clearfix">
                                            <input type="hidden" name="postid" id="postid" value="<?php echo $cat_fid; ?>">

                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="acc_name" class="form-control"
                                                        name="acc_name" placeholder="Expense Account Name" required value="<?php echo $fetch_department['category'];   ?>">
                                                </div>
                                            </div>
        ...
        $(document).ready(function () {
            ...
            $("#myForm").on('submit', (function (e) {
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        url: "ajax/update_expenses_category",
                        type: "post",
                        data: datas,
                        contentType: false,
                        cache: false,
                        ...
                        success: (data) => {
                            ...
                            if (data.trim() == "success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "Expenses category updated, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    var btn = $("#reset-btn");
