...
$product_name = base64_decode($app->get_request('st'));
$pid = ($app->get_request('fid'));
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Add New Order</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="purchase_order"><button class="btn btn-default hidden-xs ml-2">Manage Purchase Order</button></a>
                                        ...
                                        <div class="row clearfix">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <input type="text" id="dpt" class="form-control" value="<?php echo $product_name;  ?>" name="product_name"
    ...
    <script>
        ...
        $(document).ready(function () {
            function validateForm() {
                ...
                if (product_name === "") {
                    Swal.fire({
                        title: "The Product Name Can Not Be Empty",
                        text: "Try Again!",
                        icon: "error"
                    });
                    return false;
                ...
                if (qty<1) {
                    Swal.fire({
                        title: "The Product Quantity Can Not Be Empty",
                        text: "Try Again!",
                        icon: "error"
                    });
                    return false;
                ...
                if (product_name.length < 5) {
                    Swal.fire({
                        title: "Error!",
                        text: "Product must be at least 8 characters long.",
                        icon: "error",
                    });
                    return false;
                }
                ...
                if (check == true) {
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            ...
                            Swal.fire({
                                title: "success!",
                                text: "Purchase Order Created, Please wait redirecting...!",
                                icon: "success",
                            });
                                setTimeout(function () {
                                var btn = $("#reset-btn");
