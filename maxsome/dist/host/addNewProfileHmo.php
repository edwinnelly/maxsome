                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item">New Profile</li>
                                <li class="breadcrumb-item active">New</li>
                            </ul>
                            <h1 class="mb-1 mt-1">Add HMO Profile</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="hmo_profiling.php"><button class="btn btn-default hidden-xs ml-2">Manage
                                    Profile</button></a>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input type="text" id="dpt" class="form-control" name="dpt"
                                                    placeholder="Name Of Profile" required>
                                            </div>
                                        </div>
