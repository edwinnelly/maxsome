                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">New Test Case</h1>
                        </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="test_name" class="form-control"
                                                        name="test_name" placeholder="Name Of test" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="test_price" class="form-control"
                                                        name="test_price" placeholder="Test Price" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="tat" class="form-control"
                                                        name="tat" placeholder="Turn Around Time" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="range" class="form-control"
                                                        name="range" placeholder="Test Range 1-9.2" required>
                                                </div>
                                            </div>
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="unit" class="form-control"
                                                        name="unit" placeholder="Test Unit 0.1-9.2" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3 col-sm-12">
                                                ...
                                                <label> Choose restrictions</label>
                                                    <select class="form-control show-tick" id="restrictions" name="restrictions">
                                                        <option value="0">Select restrictions</option>
                                                        <?php
                    ...
                    $.ajax({
                        ...
                        success: (data) => {
                            if (data.trim() == "success") {
                                Swal.fire({
                                    title: "success!",
                                    text: "Test case Created, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    var btn = $("#reset-btn");
