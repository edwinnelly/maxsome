                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown show">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                ...
                                                                <a class="dropdown-item" href="patient_radiography_profile.php.php?fid=<?php echo $value['pid']; ?>&&st=<?php echo base64_encode($app->stringFormat($value['patient_name'], 20)); ?>
                                                                ">Radiography Profile</a>
