...
$department_test = "SELECT patient_test.*,lab_test_case.*,patient_test.dated_created as crdate from patient_test JOIN lab_test_case ON patient_test.test_id=lab_test_case.id WHERE patient_test.dpt=$fetch_dpt and patient_test.status=2
";
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                 ...
                                                 ?>
                                                    ...
                                                    <td>
                                                        <p class="mb-0">
                                                        <span class="badge badge-warning"> <?php  echo $app->time_ago($fetch_dpt['crdate']);  ?></span> </p>
                                                    </td>
                                                    <td>
                                                        <p>
                                                 ...
                                                 ?></span> 
                                                    ...
                                                    <td>
                                                        ...
                                                        <img src="upload.png" height="40" style="cursor: pointer" data-smkey='<?php echo $fetch_dpt['passkey']; ?>' data-result='<?php echo $fetch_dpt['result']; ?>' data-commemt='<?php echo $fetch_dpt['comments']; ?>' class="delete_emp">
                                                    </td>
        ...
        $(document).on('click', '.delete_emp', function () {
            ...
            $("#delete_emp").click(function () {
                ...
                if (smkey_val === '' || smkey_val === 0) {
                    ...
                    $.ajax({
                        url: "ajax/upload_test_result_dpt",
                        method: "POST",
                        data: {
                            smkey_val: smkey_val,result:result,commemt:commemt
                        },
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" id="result" placeholder="Enter Result Here"></textarea>
            ...
            <div class="modal-footer">
                    <img src="upload.png" height="40" style="cursor: pointer;" id="delete_emp">
