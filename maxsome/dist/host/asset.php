...
$fetch_dpt = $app->fetch_query($asset_sql);
?>
<!doctype html>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item active">Asset Mgt</li>
                            </ul>
                            <h1 class="mb-1 mt-1">Asset Mgt</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="asset_add"><button class="btn btn-secondary hidden-xs">Add New
                            Asset</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-bordered table-hover js-basic-example dataTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-top-0">Asset Type</th>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?= $fetch_dpt['asset_name']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo $fetch_dpt['purchase_date']; ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo ($fetch_dpt['asset_type']); ?>
                                                        </h6>
                                                    </td>
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo ($fetch_dpt['current_value']); ?>
                                                        </h6>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo htmlspecialchars($fetch_dpt['condition_asset']); ?>
                                                        </h6>
                                                    </td>
                                                    
                                                    <td>
                                                        <a
                                                            href="asset_edit?fid=<?php echo base64_encode($fetch_dpt['asset_id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['asset_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-id="<?php echo  $fetch_dpt['asset_id']; ?>"
                                                                data-dpt="<?php echo ($fetch_dpt['asset_name']); ?>"></i></button>
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Asset Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do You Want To Delete The Asset</h5>
            </div>
