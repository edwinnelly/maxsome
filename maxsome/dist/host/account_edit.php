...
//fetch the category
$sqls = "select * from account_list where id = $cat_fid";
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Edit Account</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="account_list"><button class="btn btn-default hidden-xs ml-2">Manage Account</button></a>
                        ...
                        <div class="card">
                            ...
                            <form name="myForm" id="myForm" method="post">
                                <form name="myForm" id="myForm" method="post" class="form mt-5">
                                    <div class="body">
                                        <div class="row clearfix">
                                            <input type="hidden" name="acc" value="<?php echo base64_encode($cat_fid);   ?>">

                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="text" id="acc_name" class="form-control" name="acc_name"
                                                        placeholder="Account Name" required value="<?php echo $fetch_department['account_name'];   ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <input type="number" class="form-control" id="acc_number" name="acc_number"
                                                        placeholder="Account Number" value="<?php echo $fetch_department['account_no'];   ?>">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    <input type="text" class="form-control" id="balance" name="balance"
                                                        placeholder="Account balance" value="<?php echo $fetch_department['balance'];   ?>">
                                                </div>
                                            </div>
