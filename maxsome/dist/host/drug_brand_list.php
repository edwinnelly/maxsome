...
$fetch_dpt = $app->fetch_query($drugs_category_brand_sql);
?>
<!doctype html>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            <ul class="breadcrumb pl-0 pb-0 ">
                                ...
                                <li class="breadcrumb-item active">Drug brand</li>
                            </ul>
                            <h1 class="mb-1 mt-1">Drug brand</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <a href="add_drug_category_brand.php"><button class="btn btn-secondary hidden-xs">Add
                            Drug Brand</button></a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($fetch_dpt as $fetch_dpt) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h6 class="mb-0">
                                                            <?php echo htmlspecialchars($fetch_dpt['category_name']); ?>
                                                        </h6>
                                                    </td>
                                                    
                                                    <td>
                                                        <a
                                                            href="drug_brand_edit?fid=<?php echo base64_encode($fetch_dpt['id']); ?>&&cat_name=<?php echo base64_encode($fetch_dpt['category_name']); ?>"><button
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-default"><i
                                                                ...
                                                                data-dpt="<?php echo ($fetch_dpt['category_name']); ?>"></i></button>
        ...
        $(document).on('click', '.delete_emp', function () {
            ...
            $("#delete_emp").click(function () {
                ...
                if (id_del === '' || id_del === 0) {
                    ...
                    $.ajax({
                        url: "ajax/delete_drug_category_brand",
                        method: "POST",
                        data: {
                            id_del: id_del
                        },
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do You Want To Delete The Category</h5>
            </div>
